...
function ensureSheet(ss, name) {
  ...
  if (sheet.getLastRow() === 0) {
    ...
    var hr = sheet.getRange(1, 1, 1, cols.length);
...
function doGet(e) {
  try {
    ...
    // PENYESUAIAN: Menambahkan pengecekan /metaads dan /gads
    ...
    else if (cleanSource.indexOf('meta-whitelist') !== -1 || cleanSource.indexOf('/metaads') !== -1) sheetName = 'Meta Whitelist';
