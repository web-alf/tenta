...
export const META_LP: Record<Lang, LpData> = {
  ...
  en: {
    ...
    hero: {
      ...
      desc: 'Facebook & Instagram Ads accounts verified under Meta partner’s official Business Manager. Stable, no spending limit, and backed by a team that knows how to escalate to Meta.',
    },
    ...
    benefits: [
      'Stable account, minimal random restrict risk',
      ...
      'Free Google Ads & Meta Ads mentorship',
...
export const GOOGLE_LP: Record<Lang, LpData> = {
  ...
  en: {
    ...
    hero: {
      ...
      titleAccent: 'Stable for Large Scale.',
      desc: 'A Google Ads account officially managed by Tentaklik, a Google Partner agency. Lower suspend risk, no spending cap, and faster appeals through the partner line.',
    },
